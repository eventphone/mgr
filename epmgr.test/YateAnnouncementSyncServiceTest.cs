...
{
    public class YateAnnouncementSyncServiceTest : YateSyncServiceTest<YateAppSyncService, AppUser>
    {
        ...
        {
            return JsonConvert.DeserializeObject<GuruData>(GuruTestData.UpdateAnnouncement);
        }
